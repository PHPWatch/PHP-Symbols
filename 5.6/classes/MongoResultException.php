...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'MongoResultException class (php.net)',
        'url' => 'https://www.php.net/manual/class.mongoresultexception.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:mongo> class MongoResultException extends MongoException ] {
