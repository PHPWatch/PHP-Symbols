...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'MongoDeleteBatch class (php.net)',
        'url' => 'https://www.php.net/manual/class.mongodeletebatch.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:mongo> class MongoDeleteBatch extends MongoWriteBatch ] {
