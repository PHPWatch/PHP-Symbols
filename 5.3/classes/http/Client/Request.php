...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'http\\Client\\Request class (php.net)',
        'url' => 'https://www.php.net/manual/class.http-client-request.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:http> <iterateable> class http\\Client\\Request extends http\\Message implements Traversable, Iterator, Serializable, Countable ] {
