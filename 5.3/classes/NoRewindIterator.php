...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'NoRewindIterator interface (php.net)',
        'url' => 'https://www.php.net/manual/class.norewinditerator.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'SPL',
  'toString' => 'Class [ <internal:SPL> <iterateable> class NoRewindIterator extends IteratorIterator implements OuterIterator, Traversable, Iterator ] {
