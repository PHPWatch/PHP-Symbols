...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'MongoDuplicateKeyException class (php.net)',
        'url' => 'https://www.php.net/manual/class.mongoduplicatekeyexception.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:mongo> class MongoDuplicateKeyException extends MongoWriteConcernException ] {
