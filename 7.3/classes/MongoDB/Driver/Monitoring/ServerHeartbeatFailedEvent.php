...
return array (
  'type' => 'class',
  'name' => 'MongoDB\\Driver\\Monitoring\\ServerHeartbeatFailedEvent',
  'meta' => 
  array (
    'type' => 'class',
    'name' => 'MongoDB\\Driver\\Monitoring\\ServerHeartbeatFailedEvent',
    ...
    array (
      0 => 
      array (
        'name' => 'MongoDB\\Driver\\Monitoring\\ServerHeartbeatFailedEvent class (php.net)',
        'url' => 'https://www.php.net/manual/class.mongodb-driver-monitoring-serverheartbeatfailedevent.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => true,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:mongodb> final class MongoDB\\Driver\\Monitoring\\ServerHeartbeatFailedEvent ] {
