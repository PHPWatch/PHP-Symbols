...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'MongoDB\\Driver\\Command class (php.net)',
        'url' => 'https://www.php.net/manual/class.mongodb-driver-command.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  - Methods [2] {
    Method [ <internal:mongodb, ctor> final public method __construct ] {
      ...
      - Parameters [2] {
        ...
        Parameter #1 [ <optional> array or NULL $commandOptions ]
      }
    }
