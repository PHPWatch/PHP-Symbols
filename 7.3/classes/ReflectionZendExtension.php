...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'ReflectionZendExtension interface (php.net)',
        'url' => 'https://www.php.net/manual/class.reflectionzendextension.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'toString' => 'Class [ <internal:Reflection> class ReflectionZendExtension implements Reflector ] {
