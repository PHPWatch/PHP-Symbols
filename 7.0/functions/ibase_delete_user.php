...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'ibase_delete_user function (php.net)',
        'url' => 'https://www.php.net/manual/function.ibase-delete-user.php',
      ),
    ),
  ),
  'doc' => false,
  ...
  'return' => NULL,
  'extension' => 'interbase',
  'toString' => 'Function [ <internal:interbase> function ibase_delete_user ] {
