...
return array (
  ...
  - Constants [115] {
    ...
    Constant [ integer RES_CONNECTION_FAILURE ] { 3 }
    Constant [ integer RES_CONNECTION_BIND_FAILURE ] { 4 }
    Constant [ integer RES_WRITE_FAILURE ] { 5 }
    Constant [ integer RES_READ_FAILURE ] { 6 }
    ...
    Constant [ integer RES_DATA_DOES_NOT_EXIST ] { 13 }
    ...
    Constant [ integer RES_INVALID_ARGUMENTS ] { 38 }
    Constant [ integer RES_PARSE_ERROR ] { 43 }
    Constant [ integer RES_PARSE_USER_ERROR ] { 44 }
    Constant [ integer RES_DEPRECATED ] { 45 }
    Constant [ integer RES_IN_PROGRESS ] { 46 }
    Constant [ integer RES_MAXIMUM_RETURN ] { 49 }
