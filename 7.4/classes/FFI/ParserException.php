...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'FFI\\ParserException interface (php.net)',
        'url' => 'https://www.php.net/manual/class.ffi-parserexception.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'FFI',
  'toString' => 'Class [ <internal:FFI> final class FFI\\ParserException extends FFI\\Exception implements Throwable ] {
