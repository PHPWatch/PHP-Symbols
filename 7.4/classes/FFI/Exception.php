...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'FFI\\Exception interface (php.net)',
        'url' => 'https://www.php.net/manual/class.ffi-exception.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'FFI',
  'toString' => 'Class [ <internal:FFI> class FFI\\Exception extends Error implements Throwable ] {
