...
return array (
  'type' => 'class',
  'name' => 'Io\\Poll\\FailedPollOperationException',
  'meta' => 
  array (
    'type' => 'class',
    'name' => 'Io\\Poll\\FailedPollOperationException',
    ...
    array (
      0 => 
      array (
        'name' => 'Io\\Poll\\FailedPollOperationException interface (php.net)',
        'url' => 'https://www.php.net/manual/class.io-poll-failedpolloperationexception.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'standard',
  'toString' => 'Class [ <internal:standard> abstract class Io\\Poll\\FailedPollOperationException extends Io\\Poll\\PollException implements Throwable, Stringable ] {
