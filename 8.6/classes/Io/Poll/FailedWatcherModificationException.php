...
return array (
  'type' => 'class',
  'name' => 'Io\\Poll\\FailedWatcherModificationException',
  'meta' => 
  array (
    'type' => 'class',
    'name' => 'Io\\Poll\\FailedWatcherModificationException',
    ...
    array (
      0 => 
      array (
        'name' => 'Io\\Poll\\FailedWatcherModificationException interface (php.net)',
        'url' => 'https://www.php.net/manual/class.io-poll-failedwatchermodificationexception.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'standard',
  'toString' => 'Class [ <internal:standard> class Io\\Poll\\FailedWatcherModificationException extends Io\\Poll\\FailedPollOperationException implements Stringable, Throwable ] {
