...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'SplMaxHeap interface (php.net)',
        'url' => 'https://www.php.net/manual/class.splmaxheap.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  - Methods [16] {
    ...
    Method [ <internal:SPL, inherits SplHeap> public method __serialize ] {
    ...
    Method [ <internal:SPL, inherits SplHeap> public method __unserialize ] {
