...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'DOMText interface (php.net)',
        'url' => 'https://www.php.net/manual/class.domtext.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'dom',
  'toString' => 'Class [ <internal:dom> class DOMText extends DOMCharacterData implements DOMChildNode ] {
