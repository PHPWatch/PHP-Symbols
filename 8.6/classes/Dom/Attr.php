...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Dom\\Attr interface (php.net)',
        'url' => 'https://www.php.net/manual/class.dom-attr.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'dom',
  'toString' => 'Class [ <internal:dom> class Dom\\Attr extends Dom\\Node ] {
  ...
  - Properties [21] {
    ...
    Property [ final public private(set) virtual ?Dom\\Element $ownerElement ]
    Property [ final public private(set) virtual bool $specified ]
  }
