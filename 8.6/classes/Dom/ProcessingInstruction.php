...
return array (
  'type' => 'class',
  'name' => 'Dom\\ProcessingInstruction',
  'meta' => 
  array (
    'type' => 'class',
    'name' => 'Dom\\ProcessingInstruction',
    ...
    array (
      0 => 
      array (
        'name' => 'Dom\\ProcessingInstruction interface (php.net)',
        'url' => 'https://www.php.net/manual/class.dom-processinginstruction.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  - Properties [19] {
    ...
    Property [ final public private(set) virtual string $target ]
  }
