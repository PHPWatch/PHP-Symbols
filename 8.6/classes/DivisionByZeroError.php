...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'DivisionByZeroError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.divisionbyzeroerror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'Core',
  'toString' => 'Class [ <internal:Core> class DivisionByZeroError extends ArithmeticError implements Stringable, Throwable ] {
