...
',
    ...
    array (
      'value' => 20,
      'toString' => 'Constant [ public int ATTR_DIRECT_QUERY ] { 20 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1004,
      'toString' => 'Constant [ public int ATTR_FOUND_ROWS ] { 1004 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1005,
      'toString' => 'Constant [ public int ATTR_IGNORE_SPACE ] { 1005 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1006,
      'toString' => 'Constant [ public int ATTR_SSL_KEY ] { 1006 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1007,
      'toString' => 'Constant [ public int ATTR_SSL_CERT ] { 1007 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1008,
      'toString' => 'Constant [ public int ATTR_SSL_CA ] { 1008 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1009,
      'toString' => 'Constant [ public int ATTR_SSL_CAPATH ] { 1009 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1010,
      'toString' => 'Constant [ public int ATTR_SSL_CIPHER ] { 1010 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1011,
      'toString' => 'Constant [ public int ATTR_SERVER_PUBLIC_KEY ] { 1011 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1012,
      'toString' => 'Constant [ public int ATTR_MULTI_STATEMENTS ] { 1012 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1013,
      'toString' => 'Constant [ public int ATTR_SSL_VERIFY_SERVER_CERT ] { 1013 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1014,
      'toString' => 'Constant [ public int ATTR_LOCAL_INFILE_DIRECTORY ] { 1014 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
