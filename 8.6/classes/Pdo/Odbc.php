...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Pdo\\Odbc interface (php.net)',
        'url' => 'https://www.php.net/manual/class.pdo-odbc.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  - Constants [107] {
    ...
    Constant [ public int ATTR_USE_CURSOR_LIBRARY ] { 1000 }
    Constant [ public int ATTR_ASSUME_UTF8 ] { 1001 }
    Constant [ public int SQL_USE_IF_NEEDED ] { 0 }
    Constant [ public int SQL_USE_DRIVER ] { 2 }
    Constant [ public int SQL_USE_ODBC ] { 1 }
  }
