...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'DOMComment interface (php.net)',
        'url' => 'https://www.php.net/manual/class.domcomment.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'dom',
  'toString' => 'Class [ <internal:dom> class DOMComment extends DOMCharacterData implements DOMChildNode ] {
