...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'IntlIterator interface (php.net)',
        'url' => 'https://www.php.net/manual/class.intliterator.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'intl',
  'toString' => 'Class [ <internal:intl> <iterateable> class IntlIterator implements Iterator, Traversable ] {
