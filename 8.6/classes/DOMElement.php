...
',
  ...
  - Properties [27] {
    ...
    Property [ final public private(set) virtual mixed $schemaTypeInfo ]
    ...
    Property [ final public private(set) virtual ?DOMElement $previousElementSibling ]
    Property [ final public private(set) virtual ?DOMElement $nextElementSibling ]
  }
  ...
  - Methods [53] {
    ...
    Method [ <internal:dom> public method insertAdjacentElement ] {
      ...
      - Parameters [2] {
        ...
        Parameter #1 [ <required> DOMElement $element ]
      }
      - Return [ ?DOMElement ]
    }
