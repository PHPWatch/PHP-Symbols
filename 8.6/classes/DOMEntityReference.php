...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'DOMEntityReference interface (php.net)',
        'url' => 'https://www.php.net/manual/class.domentityreference.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'dom',
  'toString' => 'Class [ <internal:dom> class DOMEntityReference extends DOMNode ] {
