...
return array (
  ...
  array (
    ...
    'PEAR_INSTALL_DIR' => '',
    'PEAR_EXTENSION_DIR' => '/usr/local/php/5.4/lib/php/extensions/no-debug-non-zts-20100525',
    'PHP_EXTENSION_DIR' => '/usr/local/php/5.4/lib/php/extensions/no-debug-non-zts-20100525',
    'PHP_PREFIX' => '/usr/local/php/5.4',
    'PHP_BINDIR' => '/usr/local/php/5.4/bin',
    'PHP_MANDIR' => '/usr/local/php/5.4/share/man',
    'PHP_LIBDIR' => '/usr/local/php/5.4/lib/php',
    'PHP_DATADIR' => '/usr/local/php/5.4/share/php',
    'PHP_SYSCONFDIR' => '/usr/local/php/5.4/etc',
    'PHP_LOCALSTATEDIR' => '/usr/local/php/5.4/var',
    'PHP_CONFIG_FILE_PATH' => '/usr/local/php/5.4/etc',
    'PHP_CONFIG_FILE_SCAN_DIR' => '/usr/local/php/5.4/etc/conf.d',
    'PHP_SHLIB_SUFFIX' => 'so',
    'PHP_EOL' => '
',
    'PHP_MAXPATHLEN' => 4096,
