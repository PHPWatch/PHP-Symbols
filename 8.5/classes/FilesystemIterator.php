...
return array (
  ...
  'is_read_only' => false,
  'extension' => 'SPL',
  'toString' => 'Class [ <internal:SPL> <iterateable> class FilesystemIterator extends DirectoryIterator implements Iterator, Traversable, SeekableIterator, Stringable ] {
  ...
  - Methods [40] {
    Method [ <internal:SPL, overwrites DirectoryIterator, ctor> public method __construct ] {
      ...
      - Parameters [2] {
        ...
        Parameter #1 [ <optional> int $flags = FilesystemIterator::KEY_AS_PATHNAME | FilesystemIterator::CURRENT_AS_FILEINFO | FilesystemIterator::SKIP_DOTS ]
      }
    }
