...
',
    ...
    array (
      'value' => 2048,
      'toString' => 'Constant [ public int SQLITE_DETERMINISTIC ] { 2048 }
',
      'visibility' => 1,
      'isFinal' => false,
    ),
    ...
    array (
      'value' => 1000,
      'toString' => 'Constant [ public int SQLITE_ATTR_OPEN_FLAGS ] { 1000 }
',
      'visibility' => 1,
      'isFinal' => false,
    ),
    ...
    array (
      'value' => 1,
      'toString' => 'Constant [ public int SQLITE_OPEN_READONLY ] { 1 }
',
      'visibility' => 1,
      'isFinal' => false,
    ),
    ...
    array (
      'value' => 2,
      'toString' => 'Constant [ public int SQLITE_OPEN_READWRITE ] { 2 }
',
      'visibility' => 1,
      'isFinal' => false,
    ),
    ...
    array (
      'value' => 4,
      'toString' => 'Constant [ public int SQLITE_OPEN_CREATE ] { 4 }
',
      'visibility' => 1,
      'isFinal' => false,
    ),
    ...
    array (
      'value' => 1001,
      'toString' => 'Constant [ public int SQLITE_ATTR_READONLY_STATEMENT ] { 1001 }
',
      'visibility' => 1,
      'isFinal' => false,
    ),
    ...
    array (
      'value' => 1002,
      'toString' => 'Constant [ public int SQLITE_ATTR_EXTENDED_RESULT_CODES ] { 1002 }
',
      'visibility' => 1,
      'isFinal' => false,
    ),
    ...
    array (
      'value' => 2048,
      'toString' => 'Constant [ public int DETERMINISTIC ] { 2048 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1,
      'toString' => 'Constant [ public int OPEN_READONLY ] { 1 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 2,
      'toString' => 'Constant [ public int OPEN_READWRITE ] { 2 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 4,
      'toString' => 'Constant [ public int OPEN_CREATE ] { 4 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1000,
      'toString' => 'Constant [ public int ATTR_OPEN_FLAGS ] { 1000 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1001,
      'toString' => 'Constant [ public int ATTR_READONLY_STATEMENT ] { 1001 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1002,
      'toString' => 'Constant [ public int ATTR_EXTENDED_RESULT_CODES ] { 1002 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
