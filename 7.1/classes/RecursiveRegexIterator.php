...
return array (
  ...
  array (
    ...
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer USE_KEY ] { 1 }
',
      'visibility' => 256,
    ),
    'INVERT_MATCH' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer INVERT_MATCH ] { 2 }
',
      'visibility' => 256,
    ),
    'MATCH' => 
    array (
      'value' => 0,
      'toString' => 'Constant [ public integer MATCH ] { 0 }
',
      'visibility' => 256,
    ),
    'GET_MATCH' => 
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer GET_MATCH ] { 1 }
',
      'visibility' => 256,
    ),
    'ALL_MATCHES' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer ALL_MATCHES ] { 2 }
',
      'visibility' => 256,
    ),
    'SPLIT' => 
    array (
      'value' => 3,
      'toString' => 'Constant [ public integer SPLIT ] { 3 }
',
      'visibility' => 256,
    ),
    'REPLACE' => 
    array (
      'value' => 4,
      'toString' => 'Constant [ public integer REPLACE ] { 4 }
',
      'visibility' => 256,
    ),
  ),
  ...
  - Constants [7] {
    Constant [ public integer USE_KEY ] { 1 }
    Constant [ public integer INVERT_MATCH ] { 2 }
    Constant [ public integer MATCH ] { 0 }
    Constant [ public integer GET_MATCH ] { 1 }
    Constant [ public integer ALL_MATCHES ] { 2 }
    Constant [ public integer SPLIT ] { 3 }
    Constant [ public integer REPLACE ] { 4 }
  }
