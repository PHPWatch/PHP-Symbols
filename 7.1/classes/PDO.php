...
return array (
  ...
  - Constants [127] {
    ...
    Constant [ public integer SQLSRV_ATTR_ENCODING ] { 1000 }
    Constant [ public integer SQLSRV_ATTR_QUERY_TIMEOUT ] { 1001 }
    Constant [ public integer SQLSRV_ATTR_DIRECT_QUERY ] { 1002 }
    Constant [ public integer SQLSRV_ATTR_CURSOR_SCROLL_TYPE ] { 1003 }
    Constant [ public integer SQLSRV_ATTR_CLIENT_BUFFER_MAX_KB_SIZE ] { 1004 }
    Constant [ public integer SQLSRV_ATTR_FETCHES_NUMERIC_TYPE ] { 1005 }
    Constant [ public integer SQLSRV_ATTR_FETCHES_DATETIME_TYPE ] { 1006 }
    Constant [ public integer SQLSRV_ATTR_FORMAT_DECIMALS ] { 1007 }
    Constant [ public integer SQLSRV_ATTR_DECIMAL_PLACES ] { 1008 }
    Constant [ public integer SQLSRV_ATTR_DATA_CLASSIFICATION ] { 1009 }
    Constant [ public integer SQLSRV_PARAM_OUT_DEFAULT_SIZE ] { -1 }
    Constant [ public integer SQLSRV_ENCODING_DEFAULT ] { 1 }
    Constant [ public integer SQLSRV_ENCODING_SYSTEM ] { 3 }
    Constant [ public integer SQLSRV_ENCODING_BINARY ] { 2 }
    Constant [ public integer SQLSRV_ENCODING_UTF8 ] { 65001 }
    Constant [ public integer SQLSRV_CURSOR_STATIC ] { 3 }
    Constant [ public integer SQLSRV_CURSOR_DYNAMIC ] { 2 }
    Constant [ public integer SQLSRV_CURSOR_KEYSET ] { 1 }
    Constant [ public integer SQLSRV_CURSOR_BUFFERED ] { 42 }
