...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'MessagePackUnpacker class (php.net)',
        'url' => 'https://www.php.net/manual/class.messagepackunpacker.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:msgpack> class MessagePackUnpacker ] {
