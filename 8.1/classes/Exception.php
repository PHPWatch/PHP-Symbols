...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Exception interface (php.net)',
        'url' => 'https://www.php.net/manual/class.exception.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'Core',
  'toString' => 'Class [ <internal:Core> class Exception implements Stringable, Throwable ] {
