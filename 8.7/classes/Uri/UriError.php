...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Uri\\UriError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.uri-urierror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'uri',
  'toString' => 'Class [ <internal:uri> class Uri\\UriError extends Error implements Throwable, Stringable ] {
