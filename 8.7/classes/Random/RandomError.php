...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Random\\RandomError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.random-randomerror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'random',
  'toString' => 'Class [ <internal:random> class Random\\RandomError extends Error implements Throwable, Stringable ] {
