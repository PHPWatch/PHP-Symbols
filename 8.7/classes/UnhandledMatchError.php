...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'UnhandledMatchError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.unhandledmatcherror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'Core',
  'toString' => 'Class [ <internal:Core> class UnhandledMatchError extends Error implements Throwable, Stringable ] {
