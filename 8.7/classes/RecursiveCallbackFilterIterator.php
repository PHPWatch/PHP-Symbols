...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'RecursiveCallbackFilterIterator interface (php.net)',
        'url' => 'https://www.php.net/manual/class.recursivecallbackfilteriterator.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'SPL',
  'toString' => 'Class [ <internal:SPL> <iterateable> class RecursiveCallbackFilterIterator extends CallbackFilterIterator implements Iterator, Traversable, OuterIterator, RecursiveIterator ] {
  ...
  - Methods [10] {
    ...
    Method [ <internal:SPL, prototype RecursiveIterator> public method getChildren ] {
      ...
      - Tentative return [ RecursiveCallbackFilterIterator ]
    }
