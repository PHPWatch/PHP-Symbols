...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Dom\\Text interface (php.net)',
        'url' => 'https://www.php.net/manual/class.dom-text.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'dom',
  'toString' => 'Class [ <internal:dom> class Dom\\Text extends Dom\\CharacterData implements Dom\\ChildNode ] {
  ...
  - Properties [19] {
    ...
    Property [ final public private(set) virtual string $wholeText ]
  }
