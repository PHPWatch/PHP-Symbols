...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Dom\\Entity interface (php.net)',
        'url' => 'https://www.php.net/manual/class.dom-entity.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'dom',
  'toString' => 'Class [ <internal:dom> class Dom\\Entity extends Dom\\Node ] {
  ...
  - Properties [17] {
    ...
    Property [ final public private(set) virtual ?string $notationName ]
  }
