...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Dom\\XMLDocument interface (php.net)',
...
',
  ...
  - Properties [33] {
    ...
    Property [ final public private(set) Dom\\Implementation $implementation ]
    Property [ public virtual string $URL ]
    Property [ public virtual string $documentURI ]
    Property [ public virtual string $characterSet ]
    Property [ public virtual string $charset ]
    Property [ public virtual string $inputEncoding ]
    Property [ final public private(set) virtual ?Dom\\DocumentType $doctype ]
    Property [ final public private(set) virtual ?Dom\\Element $documentElement ]
    Property [ public virtual ?Dom\\HTMLElement $body ]
    Property [ final public private(set) virtual ?Dom\\HTMLElement $head ]
    Property [ public virtual string $title ]
  ...
  - Methods [52] {
    ...
    Method [ <internal:dom, inherits Dom\\Document> public method getElementsByClassName ] {
