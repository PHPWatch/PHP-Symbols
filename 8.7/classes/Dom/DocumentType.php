...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Dom\\DocumentType interface (php.net)',
        'url' => 'https://www.php.net/manual/class.dom-documenttype.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'dom',
  'toString' => 'Class [ <internal:dom> class Dom\\DocumentType extends Dom\\Node implements Dom\\ChildNode ] {
  ...
  - Properties [20] {
    ...
    Property [ final public private(set) virtual string $name ]
    Property [ final public private(set) virtual Dom\\DtdNamedNodeMap $entities ]
    Property [ final public private(set) virtual Dom\\DtdNamedNodeMap $notations ]
    Property [ final public private(set) virtual string $publicId ]
    Property [ final public private(set) virtual string $systemId ]
    Property [ final public private(set) virtual ?string $internalSubset ]
  }
