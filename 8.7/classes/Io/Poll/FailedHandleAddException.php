...
return array (
  'type' => 'class',
  'name' => 'Io\\Poll\\FailedHandleAddException',
  'meta' => 
  array (
    'type' => 'class',
    'name' => 'Io\\Poll\\FailedHandleAddException',
    ...
    array (
      0 => 
      array (
        'name' => 'Io\\Poll\\FailedHandleAddException interface (php.net)',
        'url' => 'https://www.php.net/manual/class.io-poll-failedhandleaddexception.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'standard',
  'toString' => 'Class [ <internal:standard> class Io\\Poll\\FailedHandleAddException extends Io\\Poll\\FailedPollOperationException implements Stringable, Throwable ] {
