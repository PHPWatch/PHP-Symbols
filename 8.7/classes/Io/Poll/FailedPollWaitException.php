...
return array (
  'type' => 'class',
  'name' => 'Io\\Poll\\FailedPollWaitException',
  'meta' => 
  array (
    'type' => 'class',
    'name' => 'Io\\Poll\\FailedPollWaitException',
    ...
    array (
      0 => 
      array (
        'name' => 'Io\\Poll\\FailedPollWaitException interface (php.net)',
        'url' => 'https://www.php.net/manual/class.io-poll-failedpollwaitexception.php',
      ),
    ),
  ),
  'comment' => false,
...
',
  ...
  'extension' => 'standard',
  'toString' => 'Class [ <internal:standard> class Io\\Poll\\FailedPollWaitException extends Io\\Poll\\FailedPollOperationException implements Stringable, Throwable ] {
