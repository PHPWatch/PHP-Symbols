...
',
  ...
  - Static methods [7] {
    Method [ <internal:intl> static public method createFromDate ] {

      - Parameters [3] {
        Parameter #0 [ <required> int $year ]
        Parameter #1 [ <required> int $month ]
        Parameter #2 [ <required> int $dayOfMonth ]
      }
      - Return [ static ]
    }

    Method [ <internal:intl> static public method createFromDateTime ] {

      - Parameters [6] {
        Parameter #0 [ <required> int $year ]
        Parameter #1 [ <required> int $month ]
        Parameter #2 [ <required> int $dayOfMonth ]
        Parameter #3 [ <required> int $hour ]
        Parameter #4 [ <required> int $minute ]
        Parameter #5 [ <optional> ?int $second = null ]
      }
      - Return [ static ]
    }
  ...
  - Methods [46] {
    ...
    Method [ <internal:intl, inherits IntlCalendar> public method setDate ] {
    ...
    Method [ <internal:intl, inherits IntlCalendar> public method setDateTime ] {
