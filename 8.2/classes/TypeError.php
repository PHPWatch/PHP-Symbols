...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'TypeError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.typeerror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'Core',
  'toString' => 'Class [ <internal:Core> class TypeError extends Error implements Throwable, Stringable ] {
