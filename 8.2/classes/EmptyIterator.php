...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'EmptyIterator interface (php.net)',
        'url' => 'https://www.php.net/manual/class.emptyiterator.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'SPL',
  'toString' => 'Class [ <internal:SPL> <iterateable> class EmptyIterator implements Iterator, Traversable ] {
