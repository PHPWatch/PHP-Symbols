...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'ArgumentCountError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.argumentcounterror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'Core',
  'toString' => 'Class [ <internal:Core> class ArgumentCountError extends TypeError implements Stringable, Throwable ] {
