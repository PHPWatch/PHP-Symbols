...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'ParseError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.parseerror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'Core',
  'toString' => 'Class [ <internal:Core> class ParseError extends CompileError implements Stringable, Throwable ] {
