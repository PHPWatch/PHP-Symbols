...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'ReflectionExtension interface (php.net)',
        'url' => 'https://www.php.net/manual/class.reflectionextension.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'toString' => 'Class [ <internal:Reflection> class ReflectionExtension implements Stringable, Reflector ] {
