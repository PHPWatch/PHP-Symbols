...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'MongoDB\\Driver\\Exception\\WriteException class (php.net)',
        'url' => 'https://www.php.net/manual/class.mongodb-driver-exception-writeexception.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:mongodb> abstract class MongoDB\\Driver\\Exception\\WriteException extends MongoDB\\Driver\\Exception\\ServerException implements Stringable, Throwable, MongoDB\\Driver\\Exception\\Exception ] {
