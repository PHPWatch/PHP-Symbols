...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'CompileError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.compileerror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'Core',
  'toString' => 'Class [ <internal:Core> class CompileError extends Error implements Throwable, Stringable ] {
