...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'DateObjectError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.dateobjecterror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'date',
  'toString' => 'Class [ <internal:date> class DateObjectError extends DateError implements Stringable, Throwable ] {
