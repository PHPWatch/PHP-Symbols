...
',
    ...
    array (
      'value' => 1000,
      'toString' => 'Constant [ public int ATTR_CONNECTION_TIMEOUT ] { 1000 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1001,
      'toString' => 'Constant [ public int ATTR_QUERY_TIMEOUT ] { 1001 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1002,
      'toString' => 'Constant [ public int ATTR_STRINGIFY_UNIQUEIDENTIFIER ] { 1002 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1003,
      'toString' => 'Constant [ public int ATTR_VERSION ] { 1003 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1004,
      'toString' => 'Constant [ public int ATTR_TDS_VERSION ] { 1004 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1005,
      'toString' => 'Constant [ public int ATTR_SKIP_EMPTY_ROWSETS ] { 1005 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ),
    'ATTR_DATETIME_CONVERT' => 
    array (
      'value' => 1006,
      'toString' => 'Constant [ public int ATTR_DATETIME_CONVERT ] { 1006 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
  ...
  - Constants [88] {
    ...
    Constant [ public int ATTR_CONNECTION_TIMEOUT ] { 1000 }
    Constant [ public int ATTR_QUERY_TIMEOUT ] { 1001 }
    Constant [ public int ATTR_STRINGIFY_UNIQUEIDENTIFIER ] { 1002 }
    Constant [ public int ATTR_VERSION ] { 1003 }
    Constant [ public int ATTR_TDS_VERSION ] { 1004 }
    Constant [ public int ATTR_SKIP_EMPTY_ROWSETS ] { 1005 }
    Constant [ public int ATTR_DATETIME_CONVERT ] { 1006 }
  }
