...
',
    ...
    array (
      'value' => 1000,
      'toString' => 'Constant [ public int ATTR_USE_BUFFERED_QUERY ] { 1000 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1001,
      'toString' => 'Constant [ public int ATTR_LOCAL_INFILE ] { 1001 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1002,
      'toString' => 'Constant [ public int ATTR_INIT_COMMAND ] { 1002 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1003,
      'toString' => 'Constant [ public int ATTR_COMPRESS ] { 1003 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1004,
      'toString' => 'Constant [ public int ATTR_DIRECT_QUERY ] { 1004 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1005,
      'toString' => 'Constant [ public int ATTR_FOUND_ROWS ] { 1005 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1006,
      'toString' => 'Constant [ public int ATTR_IGNORE_SPACE ] { 1006 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1007,
      'toString' => 'Constant [ public int ATTR_SSL_KEY ] { 1007 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1008,
      'toString' => 'Constant [ public int ATTR_SSL_CERT ] { 1008 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1009,
      'toString' => 'Constant [ public int ATTR_SSL_CA ] { 1009 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1010,
      'toString' => 'Constant [ public int ATTR_SSL_CAPATH ] { 1010 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1011,
      'toString' => 'Constant [ public int ATTR_SSL_CIPHER ] { 1011 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1012,
      'toString' => 'Constant [ public int ATTR_SERVER_PUBLIC_KEY ] { 1012 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1013,
      'toString' => 'Constant [ public int ATTR_MULTI_STATEMENTS ] { 1013 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1014,
      'toString' => 'Constant [ public int ATTR_SSL_VERIFY_SERVER_CERT ] { 1014 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1015,
      'toString' => 'Constant [ public int ATTR_LOCAL_INFILE_DIRECTORY ] { 1015 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
  ...
  - Methods [15] {
    Method [ <internal:pdo_mysql> public method getWarningCount ] {
