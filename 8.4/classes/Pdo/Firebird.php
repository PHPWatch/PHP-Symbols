...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'Pdo\\Firebird interface (php.net)',
        'url' => 'https://www.php.net/manual/class.pdo-firebird.php',
      ),
    ),
  ),
  'comment' => false,
...
',
    ...
    array (
      'value' => 1000,
      'toString' => 'Constant [ public int ATTR_DATE_FORMAT ] { 1000 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1001,
      'toString' => 'Constant [ public int ATTR_TIME_FORMAT ] { 1001 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1002,
      'toString' => 'Constant [ public int ATTR_TIMESTAMP_FORMAT ] { 1002 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1003,
      'toString' => 'Constant [ public int TRANSACTION_ISOLATION_LEVEL ] { 1003 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1004,
      'toString' => 'Constant [ public int READ_COMMITTED ] { 1004 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1005,
      'toString' => 'Constant [ public int REPEATABLE_READ ] { 1005 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1006,
      'toString' => 'Constant [ public int SERIALIZABLE ] { 1006 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 1007,
      'toString' => 'Constant [ public int WRITABLE_TRANSACTION ] { 1007 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
  ...
  - Constants [92] {
    ...
    Constant [ public int TRANSACTION_ISOLATION_LEVEL ] { 1003 }
    Constant [ public int READ_COMMITTED ] { 1004 }
    Constant [ public int REPEATABLE_READ ] { 1005 }
    Constant [ public int SERIALIZABLE ] { 1006 }
    Constant [ public int WRITABLE_TRANSACTION ] { 1007 }
  }
