...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => '_ZendTestChildClass class (php.net)',
        'url' => 'https://www.php.net/manual/class._zendtestchildclass.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:zend_test> class _ZendTestChildClass extends _ZendTestClass implements _ZendTestInterface, Stringable ] {
  ...
  - Static methods [2] {
    Method [ <internal:zend_test, inherits _ZendTestClass> static public method is_object ] {
    ...
    Method [ <internal:zend_test, inherits _ZendTestClass> static public method variadicTest ] {
  ...
  - Methods [4] {
    Method [ <internal:zend_test, overwrites _ZendTestClass, prototype _ZendTestClass> public method returnsThrowable ] {
    ...
    Method [ <internal, deprecated:zend_test, inherits _ZendTestClass, prototype Stringable> public method __toString ] {
    ...
    Method [ <internal:zend_test, inherits _ZendTestClass> public method returnsStatic ] {
    ...
    Method [ <internal:zend_test, inherits _ZendTestClass> public method takesUnionType ] {
