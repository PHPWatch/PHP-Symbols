...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'SoapClient interface (php.net)',
        'url' => 'https://www.php.net/manual/class.soapclient.php',
      ),
    ),
  ),
  'comment' => false,
