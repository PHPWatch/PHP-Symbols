...
',
    ...
    array (
      'value' => 1,
      'toString' => 'Constant [ public int IGNORE_SPACE ] { 1 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 2,
      'toString' => 'Constant [ public int CASE_INSENSITIVE ] { 2 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 4,
      'toString' => 'Constant [ public int ADD_CASE_MAPPINGS ] { 4 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
    ...
    array (
      'value' => 6,
      'toString' => 'Constant [ public int SIMPLE_CASE_INSENSITIVE ] { 6 }
',
      'visibility' => 1,
      'isFinal' => false,
      'type' => 'int',
