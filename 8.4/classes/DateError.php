...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'DateError interface (php.net)',
        'url' => 'https://www.php.net/manual/class.dateerror.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  'extension' => 'date',
  'toString' => 'Class [ <internal:date> class DateError extends Error implements Throwable, Stringable ] {
