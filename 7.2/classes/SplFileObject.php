...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'SplFileObject interface (php.net)',
        'url' => 'https://www.php.net/manual/class.splfileobject.php',
      ),
    ),
  ),
  'comment' => false,
  ...
  array (
    ...
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer DROP_NEW_LINE ] { 1 }
',
      'visibility' => 256,
    ),
    'READ_AHEAD' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer READ_AHEAD ] { 2 }
',
      'visibility' => 256,
    ),
    'SKIP_EMPTY' => 
    array (
      'value' => 4,
      'toString' => 'Constant [ public integer SKIP_EMPTY ] { 4 }
',
      'visibility' => 256,
    ),
    'READ_CSV' => 
    array (
      'value' => 8,
      'toString' => 'Constant [ public integer READ_CSV ] { 8 }
',
      'visibility' => 256,
    ),
  ),
  ...
  'extension' => 'SPL',
  'toString' => 'Class [ <internal:SPL> <iterateable> class SplFileObject extends SplFileInfo implements RecursiveIterator, Traversable, Iterator, SeekableIterator ] {

  - Constants [4] {
    Constant [ public integer DROP_NEW_LINE ] { 1 }
    Constant [ public integer READ_AHEAD ] { 2 }
    Constant [ public integer SKIP_EMPTY ] { 4 }
    Constant [ public integer READ_CSV ] { 8 }
  }
