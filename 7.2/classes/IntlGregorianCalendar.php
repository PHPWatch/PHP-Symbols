...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'IntlGregorianCalendar interface (php.net)',
  ...
  array (
    ...
    array (
      'value' => 0,
      'toString' => 'Constant [ public integer FIELD_ERA ] { 0 }
',
      'visibility' => 256,
    ),
    'FIELD_YEAR' => 
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer FIELD_YEAR ] { 1 }
',
      'visibility' => 256,
    ),
    'FIELD_MONTH' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer FIELD_MONTH ] { 2 }
',
      'visibility' => 256,
    ),
    'FIELD_WEEK_OF_YEAR' => 
    array (
      'value' => 3,
      'toString' => 'Constant [ public integer FIELD_WEEK_OF_YEAR ] { 3 }
',
      'visibility' => 256,
    ),
    'FIELD_WEEK_OF_MONTH' => 
    array (
      'value' => 4,
      'toString' => 'Constant [ public integer FIELD_WEEK_OF_MONTH ] { 4 }
',
      'visibility' => 256,
    ),
    'FIELD_DATE' => 
    array (
      'value' => 5,
      'toString' => 'Constant [ public integer FIELD_DATE ] { 5 }
',
      'visibility' => 256,
    ),
    'FIELD_DAY_OF_YEAR' => 
    array (
      'value' => 6,
      'toString' => 'Constant [ public integer FIELD_DAY_OF_YEAR ] { 6 }
',
      'visibility' => 256,
    ),
    'FIELD_DAY_OF_WEEK' => 
    array (
      'value' => 7,
      'toString' => 'Constant [ public integer FIELD_DAY_OF_WEEK ] { 7 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 8,
      'toString' => 'Constant [ public integer FIELD_DAY_OF_WEEK_IN_MONTH ] { 8 }
',
      'visibility' => 256,
    ),
    'FIELD_AM_PM' => 
    array (
      'value' => 9,
      'toString' => 'Constant [ public integer FIELD_AM_PM ] { 9 }
',
      'visibility' => 256,
    ),
    'FIELD_HOUR' => 
    array (
      'value' => 10,
      'toString' => 'Constant [ public integer FIELD_HOUR ] { 10 }
',
      'visibility' => 256,
    ),
    'FIELD_HOUR_OF_DAY' => 
    array (
      'value' => 11,
      'toString' => 'Constant [ public integer FIELD_HOUR_OF_DAY ] { 11 }
',
      'visibility' => 256,
    ),
    'FIELD_MINUTE' => 
    array (
      'value' => 12,
      'toString' => 'Constant [ public integer FIELD_MINUTE ] { 12 }
',
      'visibility' => 256,
    ),
    'FIELD_SECOND' => 
    array (
      'value' => 13,
      'toString' => 'Constant [ public integer FIELD_SECOND ] { 13 }
',
      'visibility' => 256,
    ),
    'FIELD_MILLISECOND' => 
    array (
      'value' => 14,
      'toString' => 'Constant [ public integer FIELD_MILLISECOND ] { 14 }
',
      'visibility' => 256,
    ),
    'FIELD_ZONE_OFFSET' => 
    array (
      'value' => 15,
      'toString' => 'Constant [ public integer FIELD_ZONE_OFFSET ] { 15 }
',
      'visibility' => 256,
    ),
    'FIELD_DST_OFFSET' => 
    array (
      'value' => 16,
      'toString' => 'Constant [ public integer FIELD_DST_OFFSET ] { 16 }
',
      'visibility' => 256,
    ),
    'FIELD_YEAR_WOY' => 
    array (
      'value' => 17,
      'toString' => 'Constant [ public integer FIELD_YEAR_WOY ] { 17 }
',
      'visibility' => 256,
    ),
    'FIELD_DOW_LOCAL' => 
    array (
      'value' => 18,
      'toString' => 'Constant [ public integer FIELD_DOW_LOCAL ] { 18 }
',
      'visibility' => 256,
    ),
    'FIELD_EXTENDED_YEAR' => 
    array (
      'value' => 19,
      'toString' => 'Constant [ public integer FIELD_EXTENDED_YEAR ] { 19 }
',
      'visibility' => 256,
    ),
    'FIELD_JULIAN_DAY' => 
    array (
      'value' => 20,
      'toString' => 'Constant [ public integer FIELD_JULIAN_DAY ] { 20 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 21,
      'toString' => 'Constant [ public integer FIELD_MILLISECONDS_IN_DAY ] { 21 }
',
      'visibility' => 256,
    ),
    'FIELD_IS_LEAP_MONTH' => 
    array (
      'value' => 22,
      'toString' => 'Constant [ public integer FIELD_IS_LEAP_MONTH ] { 22 }
',
      'visibility' => 256,
    ),
    'FIELD_FIELD_COUNT' => 
    array (
      'value' => 24,
      'toString' => 'Constant [ public integer FIELD_FIELD_COUNT ] { 24 }
',
      'visibility' => 256,
    ),
    'FIELD_DAY_OF_MONTH' => 
    array (
      'value' => 5,
      'toString' => 'Constant [ public integer FIELD_DAY_OF_MONTH ] { 5 }
',
      'visibility' => 256,
    ),
    'DOW_SUNDAY' => 
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer DOW_SUNDAY ] { 1 }
',
      'visibility' => 256,
    ),
    'DOW_MONDAY' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer DOW_MONDAY ] { 2 }
',
      'visibility' => 256,
    ),
    'DOW_TUESDAY' => 
    array (
      'value' => 3,
      'toString' => 'Constant [ public integer DOW_TUESDAY ] { 3 }
',
      'visibility' => 256,
    ),
    'DOW_WEDNESDAY' => 
    array (
      'value' => 4,
      'toString' => 'Constant [ public integer DOW_WEDNESDAY ] { 4 }
',
      'visibility' => 256,
    ),
    'DOW_THURSDAY' => 
    array (
      'value' => 5,
      'toString' => 'Constant [ public integer DOW_THURSDAY ] { 5 }
',
      'visibility' => 256,
    ),
    'DOW_FRIDAY' => 
    array (
      'value' => 6,
      'toString' => 'Constant [ public integer DOW_FRIDAY ] { 6 }
',
      'visibility' => 256,
    ),
    'DOW_SATURDAY' => 
    array (
      'value' => 7,
      'toString' => 'Constant [ public integer DOW_SATURDAY ] { 7 }
',
      'visibility' => 256,
    ),
    'DOW_TYPE_WEEKDAY' => 
    array (
      'value' => 0,
      'toString' => 'Constant [ public integer DOW_TYPE_WEEKDAY ] { 0 }
',
      'visibility' => 256,
    ),
    'DOW_TYPE_WEEKEND' => 
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer DOW_TYPE_WEEKEND ] { 1 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer DOW_TYPE_WEEKEND_OFFSET ] { 2 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 3,
      'toString' => 'Constant [ public integer DOW_TYPE_WEEKEND_CEASE ] { 3 }
',
      'visibility' => 256,
    ),
    'WALLTIME_FIRST' => 
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer WALLTIME_FIRST ] { 1 }
',
      'visibility' => 256,
    ),
    'WALLTIME_LAST' => 
    array (
      'value' => 0,
      'toString' => 'Constant [ public integer WALLTIME_LAST ] { 0 }
',
      'visibility' => 256,
    ),
    'WALLTIME_NEXT_VALID' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer WALLTIME_NEXT_VALID ] { 2 }
',
      'visibility' => 256,
    ),
  ),
