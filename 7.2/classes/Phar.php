...
',
  ...
  - Constants [26] {
    ...
    Constant [ public integer BZ2 ] { 8192 }
    Constant [ public integer GZ ] { 4096 }
    Constant [ public integer NONE ] { 0 }
    Constant [ public integer PHAR ] { 1 }
    Constant [ public integer TAR ] { 2 }
    Constant [ public integer ZIP ] { 3 }
    Constant [ public integer COMPRESSED ] { 61440 }
    Constant [ public integer PHP ] { 0 }
    Constant [ public integer PHPS ] { 1 }
    Constant [ public integer MD5 ] { 1 }
    Constant [ public integer OPENSSL ] { 16 }
    Constant [ public integer SHA1 ] { 2 }
    Constant [ public integer SHA256 ] { 3 }
    Constant [ public integer SHA512 ] { 4 }
  }
