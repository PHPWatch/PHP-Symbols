...
return array (
  ...
  array (
    ...
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer STD_PROP_LIST ] { 1 }
',
      'visibility' => 256,
    ),
    'ARRAY_AS_PROPS' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer ARRAY_AS_PROPS ] { 2 }
',
      'visibility' => 256,
    ),
    'CHILD_ARRAYS_ONLY' => 
    array (
      'value' => 4,
      'toString' => 'Constant [ public integer CHILD_ARRAYS_ONLY ] { 4 }
',
      'visibility' => 256,
    ),
  ),
  ...
  - Constants [3] {
    ...
    Constant [ public integer CHILD_ARRAYS_ONLY ] { 4 }
  }
