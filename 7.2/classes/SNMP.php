...
return array (
  ...
  array (
    ...
    array (
      'value' => 0,
      'toString' => 'Constant [ public integer VERSION_1 ] { 0 }
',
      'visibility' => 256,
    ),
    'VERSION_2c' => 
    array (
      'value' => 1,
      'toString' => 'Constant [ public integer VERSION_2c ] { 1 }
',
      'visibility' => 256,
    ),
    'VERSION_2C' => 
...
',
    ...
    array (
      'value' => 3,
      'toString' => 'Constant [ public integer VERSION_3 ] { 3 }
',
      'visibility' => 256,
    ),
    'ERRNO_NOERROR' => 
    array (
      'value' => 0,
      'toString' => 'Constant [ public integer ERRNO_NOERROR ] { 0 }
',
      'visibility' => 256,
    ),
    'ERRNO_ANY' => 
    array (
      'value' => 126,
      'toString' => 'Constant [ public integer ERRNO_ANY ] { 126 }
',
      'visibility' => 256,
    ),
    'ERRNO_GENERIC' => 
    array (
      'value' => 2,
      'toString' => 'Constant [ public integer ERRNO_GENERIC ] { 2 }
',
      'visibility' => 256,
    ),
    'ERRNO_TIMEOUT' => 
    array (
      'value' => 4,
      'toString' => 'Constant [ public integer ERRNO_TIMEOUT ] { 4 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 8,
      'toString' => 'Constant [ public integer ERRNO_ERROR_IN_REPLY ] { 8 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 16,
      'toString' => 'Constant [ public integer ERRNO_OID_NOT_INCREASING ] { 16 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 32,
      'toString' => 'Constant [ public integer ERRNO_OID_PARSING_ERROR ] { 32 }
',
      'visibility' => 256,
    ),
    ...
    array (
      'value' => 64,
      'toString' => 'Constant [ public integer ERRNO_MULTIPLE_SET_QUERIES ] { 64 }
',
      'visibility' => 256,
    ),
  ),
