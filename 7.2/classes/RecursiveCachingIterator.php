...
',
  ...
  - Constants [6] {
    Constant [ public integer CALL_TOSTRING ] { 1 }
    Constant [ public integer CATCH_GET_CHILD ] { 16 }
    Constant [ public integer TOSTRING_USE_KEY ] { 2 }
    Constant [ public integer TOSTRING_USE_CURRENT ] { 4 }
    Constant [ public integer TOSTRING_USE_INNER ] { 8 }
    Constant [ public integer FULL_CACHE ] { 256 }
  }
