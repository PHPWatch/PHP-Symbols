...
return array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'name' => 'MongoWriteConcernException class (php.net)',
        'url' => 'https://www.php.net/manual/class.mongowriteconcernexception.php',
      ),
    ),
  ),
  'interfaces' => 
  ...
  'is_final' => false,
  'is_read_only' => false,
  'toString' => 'Class [ <internal:mongo> class MongoWriteConcernException extends MongoCursorException ] {
